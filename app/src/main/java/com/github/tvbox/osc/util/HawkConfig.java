...
public class HawkConfig {
   ...
   public static final String CONFIG_URL = "https://tvbox.238238.xyz/app/99tvdc.properties";//久久动态
    ...
    public static String API_KEY = "417665bc3cca9ff820cc2a60dba9bb3a"; //接口密钥
